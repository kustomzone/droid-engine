...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = new _Engine2.default();

	// Create some scenes
	var hyrule = new _Level2.default('Hyrule');

	// Create some entities
	var player = new _Player2.default("Mario");
	var enemy = new _Player2.default('Bowser');
	...
	Game.Update();
	Game.Render();
	player.Components[0].Test(1500, player, enemy, function () {
	  console.log('And now ' + enemy.name + ' is running home like a little bitch!');
	});

	enemy.Components[0].Test(200, enemy, player, function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Engine = function () {
	  ...
	  _createClass(Engine, [{
	    key: 'Initialize',
	    value: function Initialize(scene) {
	    ...
	    value: function RemoveScene(scene) {
	      if (scene != null) {
	        _lodash2.default.pull(this.Scenes, scene);
	        //scene = null
	      }
	    }
	  }, {
	    key: 'ChangeScene',
	    value: function ChangeScene(newScene) {
	...
	var Entity = function () {
	  ...
	  _createClass(Entity, [{
	    ...
	    value: function RemoveComponent(component) {
	      _lodash2.default.pull(this.Components, component);
	    }
	  }, {
	    key: 'Update',
	    value: function Update() {
	      ...
	      _lodash2.default.each(this.Components, function (value) {
	        console.log(_this.name + ' updated ' + value.name);
	        value.Update();
	      });
	    }
	  }, {
	    ...
	    value: function Render() {
	      ...
	      _lodash2.default.each(this.Components, function (value) {
	        console.log(_this2.name + ' rendered ' + value.name);
	        value.Render();
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Component = function () {
	  function Component(componentName, scene, entity, isActive, isVisible) {
	  ...
	  _createClass(Component, [{
	    key: 'AddedToEntity',
	    value: function AddedToEntity(entity) {}
	  }, {
	    key: 'RemovedFromEntity',
	    value: function RemovedFromEntity(entity) {}
	  }, {
	    key: 'AddedToScene',
	...
	var Scene = function () {
	  ...
	  _createClass(Scene, [{
	    ...
	    value: function RemoveEntity(entity) {
	      _lodash2.default.pull(this.Entities, entity);
	    }
	  }, {
	    key: 'Update',
	    value: function Update() {
	      ...
	      _lodash2.default.each(this.Entities, function (value) {
	        console.log(_this.name + ' updated ' + value.name);
	        value.Update();
	      });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TestComponent = function (_Component) {
	  ...
	  function TestComponent(componentName, scene, entity, isActive, isVisible) {
	    _classCallCheck(this, TestComponent);

	    var _this = _possibleConstructorReturn(this, (TestComponent.__proto__ || Object.getPrototypeOf(TestComponent)).call(this));

	    _this.name = componentName; // The name identifier of this Component
	    _this.Scene = scene; // The Scene that contains this Component
	    _this.Entity = entity; // The Entity that contains this Component
	    _this.Active = isActive; // Does this Component get Updated?
	    _this.Visible = isVisible; // Does this Component get Rendered?
	    _this.Position = null; // The Vec2 position of this Component relative to the parent Entity
	    _this.ScenePosition = null; // The vec2 position of this Component within the Scene
	  ...
	  _createClass(TestComponent, [{
	    key: 'Test',
	    value: function Test(damage, entity, otherEntity, callback) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Player = function (_Entity) {
	  ...
	  function Player(playerName) {
	    ...
	    var fireball = new _TestComponent2.default('Fireball', _this.Scene, _this, true, true);

	    _this.AddComponent(fireball);
	    return _this;
	  }
